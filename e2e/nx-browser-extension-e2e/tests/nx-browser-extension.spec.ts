...
describe('nx-browser-extension e2e', () => {
  ...
  beforeAll(() => {
    ensureNxProject(
      '@codeimpact/nx-browser-extension',
  ...
  it('should create nx-browser-extension', async () => {
    const project = uniq('nx-browser-extension');
    await runNxCommandAsync(
      `generate @codeimpact/nx-browser-extension:nx-browser-extension ${project}`
    );
  ...
  describe('--tags', () => {
    it('should add tags to the project', async () => {
      const projectName = uniq('nx-browser-extension');
      ensureNxProject(
        '@codeimpact/nx-browser-extension',
        'dist/packages/nx-browser-extension'
      );
